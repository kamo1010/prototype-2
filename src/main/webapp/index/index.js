...
function openSocket() {
    ...
    socket.onopen = function(event) {
        window.open("http://" + window.location.hostname + ":8080/prototype-two/portal.html")
    };
...
/* function logOut() {
    if (token !== "") {
        var request = new XMLHttpRequest();
        request.open("POST", "http://" + window.location.hostname + ":8080/prototype-two/rest/auth/out");
